		...
		<div class="well">
			<div class="row">
				...
				<div class="col-sm-12 action-container" style="display: none;">
					...
					<p class="">Material</p>
					<div class="btn-group ">
						<a rel="tooltip" title="Caution: uses lots of memory" href="javascript:void(0);" data-action="solid"     class="btn btn-primary material active">Solid</a>
					...
					<div class="btn-group ">
						<a rel="tooltip" title="Caution: uses lots of memory" href="javascript:void(0);" data-action="off"     class="btn btn-primary rotation active">Off</a>
					...
					<div class="btn-group ">
						<a rel="tooltip" title="Caution: uses lots of memory" href="javascript:void(0);" data-action="show"     class="btn btn-primary plane active">Show</a>
