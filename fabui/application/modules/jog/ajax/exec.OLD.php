...
$_functions["directions"]["up"]         = "G91".PHP_EOL."G0 Y+".$_step;
$_functions["directions"]["up-right"]   = "G91".PHP_EOL."G0 Y+".$_step." X+".$_step;
$_functions["directions"]["up-left"]    = "G91".PHP_EOL."G0 Y+".$_step." X-".$_step;
$_functions["directions"]["down"]       = "G91".PHP_EOL."G0 Y-".$_step;
$_functions["directions"]["down-right"] = "G91".PHP_EOL."G0 Y-".$_step." X+".$_step;
$_functions["directions"]["down-left"]  = "G91".PHP_EOL."G0 Y-".$_step." X-".$_step;
$_functions["directions"]["left"]       = "G91".PHP_EOL."G0 X-".$_step;
$_functions["directions"]["right"]      = "G91".PHP_EOL."G0 X+".$_step;
...
switch ($function){
    ...
    case 'get-temp':
		...
		break;
    case 'zup':
		$command_value = 'G91'.PHP_EOL.'G0 Z+'.$z_step;
		break;
    case 'zdown':
		$command_value = 'G91'.PHP_EOL.'G0 Z-'.$z_step;
		break;
