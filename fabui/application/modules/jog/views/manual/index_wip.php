...
<div class="modal-body">
		...
		<div class="col-sm-12">
			...
			<div class="well well-sm">
				<ul class="list-unstyled">
					<li class="code"><h6>Implemented Codes</h6></li>
		            <li class="code G0"><strong>G0</strong> - Coordinated Movement X Y Z E</li>
					<li class="code G1"><strong>G1</strong> - Coordinated Movement X Y Z E</li>
					<li class="code G2"><strong>G2</strong> - CW ARC</li>
					<li class="code G3"><strong>G3</strong> - CCW ARC</li>
					<li class="code G4"><strong>G4</strong> - Dwell S<seconds> or P<milliseconds></li>
					<li class="code G10"><strong>G10</strong> - retract filament according to settings of M207</li>
					<li class="code G11"><strong>G11</strong> - retract recover filament according to settings of M208</li>
					<li class="code G27"><strong>G27</strong> - Home Z axis max (no plane needed)</li>
					<li class="code G28"><strong>G28</strong> - Home all Axis</li>
					<li class="code G29"><strong>G29</strong> - Detailed Z-Probe, probes the bed at 3 or more points.  Will fail if you haven't homed yet.</li>
					<li class="code G90"><strong>G90</strong> - Use Absolute Coordinates</li>
					<li class="code G91"><strong>G91</strong> - Use Relative Coordinates</li>
					<li class="code G91"><strong>G92</strong> - Set current position to coordinates given</li>
		
					<li class="code"><hr></li>
					<li class="code"><h6>M Codes</h6></li>
					<li class="code M0"><strong>M0</strong> - Unconditional stop - Wait for user to press a button on the LCD (Only if ULTRA_LCD is enabled)</li>
					<li class="code M1"><strong>M1</strong> - Same as M0</li>
					<li class="code M17"><strong>M17</strong> - Enable/Power all stepper motors</li>
					<li class="code M18"><strong>M18</strong> - Disable all stepper motors; same as M84</li>
					<li class="code M20"><strong>M20</strong> - List SD card</li>
					<li class="code M21"><strong>M21</strong> - Init SD card</li>
					<li class="code M22"><strong>M22</strong> - Release SD card</li>
					<li class="code M23"><strong>M23</strong> - Select SD file (M23 filename.g)</li>
					<li class="code M24"><strong>M24</strong> - Start/resume SD print</li>
					<li class="code M25"><strong>M25</strong> - Pause SD print</li>
					<li class="code M26"><strong>M26</strong> - Set SD position in bytes (M26 S12345)</li>
					<li class="code M27"><strong>M27</strong> - Report SD print status</li>
					<li class="code M28"><strong>M28</strong> - Start SD write (M28 filename.g)</li>
					<li class="code M29"><strong>M29</strong> - Stop SD write</li>
					<li class="code M30"><strong>M30</strong> - Delete file from SD (M30 filename.g)</li>
					
					
					<li class="code M31"><strong>M31</strong> - Output time since last M109 or SD card start to serial</li>
					<li class="code M32"><strong>M32</strong> - Select file and start SD print (Can be used _while_ printing from SD card files):
       															syntax "M32 /path/filename#", or "M32 S<startpos bytes> !filename#"
       															Call gcode file : "M32 P !filename#" and return to caller file after finishing (similar to #include).
       															The '#' is necessary when calling from within sd files, as it stops buffer prereading</li>
					<li class="code M42"><strong>M42</strong> - Change pin status via gcode Use M42 Px Sy to set pin x to value y, when omitting Px the onboard led will be used.</li>
	...
	<div class="row">
		<div class="col-sm-12">
			<pre style="height: 400px; overflow: auto !important;">
Implemented Codes
-------------------
G0  -> G1
