...
<div class="row">
	<div class="col-sm-6">
		<div class="well">
			...
			<h5><i class="fab-lg fab-fw icon-fab-term txt-color-red"></i>Extruder <span id="ext-degrees" class="label label-info pull-right"></span>&nbsp;<span id="ext-actual-degrees" class="label label-danger pull-right margin-right-5"></span></h5>
	...
	<div class="col-sm-6">
		<div class="well">
			...
			<h5><i class="fab-lg fab-fw icon-fab-term txt-color-red"></i>Bed <span id="bed-degrees" class="label label-info pull-right"></span><span id="bed-actual-degrees" class="label label-danger pull-right margin-right-5"></span></h5>
			...
			<div class="margin-bottom-10">
				...
				<div class="btn-group pull-right">
					...
					<ul class="dropdown-menu">
						<li>
							<a id="home-all-axis"    href="javascript:void(0)"  title="Home all axis">Home All axis</a>
						</li>
						<li>
						...
						<li>
							<a id="get-temp-ext" href="javascript:void(0)"  title="Temperature">Temperature</a>
						</li>
						<li>
							<a id="bed-align" href="javascript:void(0)" class="macro" title="Auto Bed Leveling">ABL</a>
						</li>
						<li>
