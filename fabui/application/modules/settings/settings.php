...
class Settings extends Module {
	...
	public function general(){
		...
		$settings = json_decode(file_get_contents($this -> config -> item('fabtotum_config_units', 'fabtotum')), TRUE);
		//print_r($settings); exit();
		
		if(!file_exists($settings['custom']['overrides'])){
		...
		*/
		...
		//$default_settings = json_decode(file_get_contents($this -> config -> item('fabtotum_config_units', 'fabtotum')), TRUE);
		//$custom_settings = json_decode(file_get_contents($this -> config -> item('fabtotum_custom_config_units', 'fabtotum')), TRUE);
		
		//$settings = $default_settings['settings_type'] == 'custom' ? $custom_settings : $default_settings;
