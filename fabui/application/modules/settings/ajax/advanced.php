...
$camera_available                 = $_POST['camera_available'] == 'yes' ? true : false;
$custom_overrides                 = $_POST['custom_overrides'];
...
$units['custom']['camera_available'] 	   = $camera_available;
$units['custom']['overrides']    		   = FABUI_PATH.'config/custom_overrides.txt';

write_file(FABUI_PATH.'config/custom_overrides.txt', strtoupper($custom_overrides), 'w');
