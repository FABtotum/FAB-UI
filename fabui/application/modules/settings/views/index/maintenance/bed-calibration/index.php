		...
		<div class="col-sm-12 text-center margin-bottom-10">
			...
			<div class="row">
					<div class="col-sm-6 text-center">
						<img style="max-width: 50%; display: inline;" class="img-responsive" src="<?php echo base_url() ?>application/modules/settings/assets/img/maintenance/bedcalibration/1.png" />
					</div>
					<div class="col-sm-6 ">
						...
						<hr>
						<p class="text-center">
							<a href="javascript:void(0);" class="btn btn-primary btn-default btn-lg do-calibration "> Start</a>
						</p> 
					</div>
				</div>			
			...
			<div class="well">
				...
				<div class="row">
					<div class="col-sm-6 text-center margin-bottom-10">
						<img style="max-width: 50%; display: inline;" class="img-responsive" src="<?php echo base_url() ?>application/modules/settings/assets/img/maintenance/bedcalibration/2.png" />
					</div>
					<div class="col-sm-6 ">
					...
					Always follow the order without skipping any point (even green ones) and repeat until all the points are green.Arrows show the direction (CW or CCW) as seen from above.</h4>
						...
						<hr>
						<p class="text-center">
							<a href="javascript:void(0);" class="btn btn-primary btn-default btn-lg do-calibration "> Calibrate again</a>
						</p>
					</div>
				</div>
