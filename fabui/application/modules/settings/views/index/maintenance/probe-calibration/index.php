          ...
          <div class="well">
          		<div class="row">
                     ...
                     <div class="col-sm-6 text-center">
                        ...
                        <button id="probe-calibration-prepare" class="btn btn-primary btn-default btn-lg">Ok</button>
                    </div>
          		</div>
          </div>
        </div>
    			...
    			<div class="row">
    				...
    				<div class="col-sm-6">
    					...
    					<div class="row text-align-center">
    						<button id="probe-calibration-calibrate" class="btn btn-primary btn-default btn-lg">Calibrate</button>
    					</div>
    				</div>
    			</div>
    ...
    <div class="row margin-top-10 calibration" id="row-normal-3" style="display:none;">
    	<div class="col-sm-12">
    		...
    		<div class="row">
    			...
    			<div class="col-sm-9">
    				<button class="btn btn-primary btn-default btn-lg pull-right calibrate-again">Calibrate again</button>
    			</div>
    		</div>
...
If the print first layer is too high or too close to the bed, use this function to finely calibrate the distance from the nozzle and the bed during 3D-prints. Usually 0.05mm increments are enough to make a difference.
    				...
    				<div class="col-sm-6">
    					...
    					<div class="row text-align-center">
    						<button id="probe-calibration-save" class="btn btn-primary btn-default btn-lg">Save</button>
    					</div>
