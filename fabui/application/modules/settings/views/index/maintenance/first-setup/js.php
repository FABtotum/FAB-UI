<script type="text/javascript">
	...
	function do_calibration(){
		...
		$.ajax({
			type: "POST",
			url : "<?php echo module_url('settings').'ajax/bed_calibration.php' ?>",
			data : {time: now},
			dataType: "html"
		}).done(function( data ) {
	...
	function prepare_feeder(){
	 	...
	 	$.ajax({
              type: "POST",
              url: "<?php echo module_url("settings").'ajax/feeder.php' ?>",
              dataType: 'json'
        }).done(function( response ) { 
	 ...
	 function finish_wizard(){
	 	...
	 	$.ajax({
              type: "POST",
              url: "<?php echo module_url("settings").'ajax/finish_wizard.php' ?>",
              dataType: 'json'
        }).done(function( response ) { 
