	...
	<tr>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Hi, <?php echo $user->first_name.' '.$user->last_name ?></h3>
						...
						<p>If you did make the request, then click <a href="<?php echo site_url('login/reset').'/'.$token ?>">here</a> to reset your password</p>
						<!-- Callout Panel -->
