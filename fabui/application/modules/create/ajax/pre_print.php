...
if($_type == 'additive'){
	...
	$_raise_bed = 'sudo python /var/www/fabui/python/gmacro.py raise_bed /var/www/temp/move_up.trace  /var/www/temp/move_up.log > /dev/null';
...
$_destination_trace    = '/var/www/temp/check_'.$_time.'.trace';
$_destination_response = '/var/www/temp/response_'.$_time.'.log';
...
/** EXEC COMMAND */
$_command        = 'sudo python /var/www/fabui/python/gmacro.py check_pre_print '.$_destination_trace.' '.$_destination_response.' > /dev/null';
