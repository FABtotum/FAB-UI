       ...
       -->
        <div class="col-sm-12 text-center">
        	<div class="alert alert-info alert-block z-override-alert" style="display:none;">
        		<p class="font-md"> During this <?php echo strtolower($label) ?> you changed Z's height, do you want to save and override the value for the next prints <!--<span class="z_override"></span>--> ? <a href="javascript:void(0);" class="btn btn-sm btn-primary save-z-override">Yes</a> </p>
        	</div>
