			...
			<div class="row margin-top load-choice" style="display: none;">
					...
					<div class="well">
						...
						<div class="row">
							...
							<div class="col-sm-6 text-center">
								<img style="max-width: 25%; display: inline;" class="img-responsive" src="<?php echo module_url('maintenance').'assets/img/spool/open-cover.png' ?>" />
							</div>
				...
				<div class="col-sm-12">
					<div class="well">
						<div class="row">
							<div class="col-sm-6 text-center">
								<img style="max-width: 25%; display: inline;" class="img-responsive" src="<?php echo module_url('maintenance').'assets/img/spool/filament_cut_spool.png' ?>" />
							</div>
							<div class="col-sm-6 text-center">
				...
				<div class="col-sm-12">
					...
					<div class="well">
						...
						<div class="row">
							...
							<div class="col-sm-6 text-center">
								<img style="max-width: 25%; display: inline;" class="img-responsive" src="<?php echo module_url('maintenance').'assets/img/spool/insert-filament.png' ?>" />
							</div>
				...
				<div class="col-sm-12">
					...
					<div class="well">
						...
						<div class="row">
							...
							<div class="col-sm-6 text-center">
								<img style="max-width: 25%; display: inline;" class="img-responsive" src="<?php echo module_url('maintenance').'assets/img/spool/filament_cut.png' ?>" />
							</div>
				...
				<div class="col-sm-12">
					...
					<div class="well">
						...
						<div class="row">
							...
							<div class="col-sm-6 text-center">
								<img style="max-width: 25%; display: inline;" class="img-responsive" src="<?php echo module_url('maintenance').'assets/img/spool/unload-filament.png' ?>" />
							</div>
