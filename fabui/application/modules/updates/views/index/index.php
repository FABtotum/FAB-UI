			...
			<table class="table table-striped table-forum">
                ...
                <tbody>
                	...
                	<tr class="<?php echo $running == true && $update_type == 'fabui' || $fabui ? 'warning' : ''; ?>">
	                    ...
	                    <td>
	                    	<?php if($internet): ?>
	                    		<h4><?php echo $fabui ? '<a> A new update is avaiable.<strong class="txt-color-red"> Get new version ' .$fabui_remote.' now!</strong></a> ' : 'Your FAB UI is up-to-date' ?>
                	...
                	<tr class="<?php echo $running == true && $update_type == 'marlin' || $marlin ? 'warning' : ''; ?>">
                        ...
                        <td>
                        	<?php if($internet): ?>
                        		<h4><?php echo $marlin ? ' <a>A new update for FABlin Firmware is avaiable.<strong class="txt-color-red"> Get new version '.$marlin_remote.' now!</strong> </a>' : 'Your FABlin Firmware is up-to-date.' ?>
