...
/** CREATE LOG FILES */
$_time                 = $_POST['time'];
//$_destination_trace    = TEMP_PATH.'check_p_scan_'.$_time.'.trace';
//$_destination_response = TEMP_PATH.'check_p_scan_'.$_time.'.log';
...
/** EXEC COMMAND */
$_command        = 'sudo python '.PYTHON_PATH.'gmacro_new.py -m p_scan  > /dev/null';
//$_command        = 'sudo python '.PYTHON_PATH.'gmacro.py p_scan '.$_destination_trace.' '.$_destination_response.' > /dev/null';
