...
/** CREATE LOG FILES */
$_time                 = $_POST['time'];
$_destination_trace    = '/var/www/temp/check_p_scan_'.$_time.'.trace';
$_destination_response = '/var/www/temp/check_p_scan_'.$_time.'.log'; 
...
$_command        = 'sudo python /var/www/fabui/python/gmacro.py p_scan '.$_destination_trace.' '.$_destination_response.' > /dev/null';
