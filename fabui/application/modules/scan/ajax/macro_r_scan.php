...
/** EXEC COMMAND */
$_command        = 'sudo python '.PYTHON_PATH.'gmacro_new.py -m r_scan  > /dev/null';
//$_command        = 'sudo python '.PYTHON_PATH.'gmacro.py r_scan '.$_destination_trace.' '.$_destination_response.' > /dev/null';
