...
$_scan_array_estimated_time     = isset($_POST['scan_array_estimated_time']) ? $_POST['scan_array_estimated_time'] : '';
$_scan_array_progress_steps     = isset($_POST['scan_array_progress_steps']) ? $_POST['scan_array_progress_steps'] : '';
$_pprocess_array_estimated_time = isset($_POST['pprocess_array_estimated_time']) ? $_POST['pprocess_array_estimated_time'] : '';
$_pprocess_array_progress_steps = isset($_POST['pprocess_array_progress_steps']) ? $_POST['pprocess_array_progress_steps'] : '';
$_scan_stats_file               = isset($_POST['scan_stats_file']) ? $_POST['scan_stats_file'] : '';
$_pprocess_stats_file           = $_POST['pprocess_stats_file'];


/** LOAD DATA FROM MONITOR JSON */
if(file_exists($_scan_monitor_file)){
	$_scan_monitor_data     = json_decode(file_get_contents($_scan_monitor_file), TRUE);
}


if(filesize($_pprocess_monitor_file) > 0){
...
if(file_exists($_scan_stats_file)){
...
/** UPDATE STATS FILE JSON */
if(file_exists($_pprocess_stats_file)){
