...
def trace(string):
	out_file = open("/var/www/fabui/slic3r/meshlab.trace","a+")
...
cmd = 'sudo xvfb-run -a -e /var/www/temp/meshlab.log meshlabserver -i /var/www/fabui/slic3r/file.asc -s /root/meshlab_script.mlx -o /var/www/fabui/slic3r/output.stl'
