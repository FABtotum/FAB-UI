...
usage= 'Usage: r_scan.py -x<first point x> -y<first point y> -i<second point x> -j<second point y> -n<density num> -a<axis increments> -b<starting deg> -e<ending deg> -o<safe_z offset> -l<log> -d<destination> -v=verborse -t<trace log>\n'

try:
	opts, args = getopt.getopt(sys.argv[1:],"x:y:i:j:n:a:b:e:o:l:d:v:t:",["x=","y=","i=","j=","n=","a=","b=","e=","o=","l=","d=","v=","t="])
