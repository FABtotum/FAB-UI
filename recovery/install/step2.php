		...
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input class="form-control input-lg" placeholder="First Name" type="text" name="first_name" id="first_name" />
				</div>
			</div>
		</div>
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					...
					<input class="form-control input-lg" placeholder="Last Name" type="text" name="last_name" id="last_name" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="form-group">
				<div class="input-group">
					<span class="input-group-addon">
						<i class="fa fa-lock fa-lg fa-fw">
						</i>
					</span>
