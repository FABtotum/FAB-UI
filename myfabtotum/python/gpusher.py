...
task_id=str(sys.argv[6])	#trace log file
...
p.send_now("M105")
#get the heating temps to fasten things up a little
trace("Loading GCODE")
gcode=gcode_load(ncfile)
#meanwhile the heater is running
trace("Optimizing Gcode with LightGCode, this may take a while...")
gcode = gcoder.LightGCode(gcode)
p.startprint(gcode)
trace("Starting print...")
...
call (['sudo php /var/www/myfabtotum/script/finalize.php '+str(task_id)+" print"], shell=True)
