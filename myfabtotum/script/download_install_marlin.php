...
if($do_update){
    ...
    sleep(3);
   	...
   	$_command = 'sudo /usr/bin/avrdude -q -V -p atmega1280 -C /etc/avrdude.conf -c arduino -b 57600 -P  /dev/ttyAMA0  \ -U flash:w:'.$_file_name.':i > /var/www/recovery/update/temp/install.log';
    shell_exec($_command);
