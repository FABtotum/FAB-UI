...
var sound_folder = 'application/layout/assets/sound/' ;
...
(function ($) {
    $.SmartMessageBox = function (settings, callback) {
        ...
        if (isIE8orlower() == 0) {
            ...
            audioElement.setAttribute('src', sound_folder + 'messagebox.mp3');
            $.get();
        ...
        if (settings.sound === true) {
            if (isIE8orlower() == 0) {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', sound_folder + 'bigbox.ogg');
                else
                    audioElement.setAttribute('src', sound_folder + 'bigbox.mp3');
    ...
    $.smallBox = function (settings, callback) {
        ...
        if (settings.sound === true) {
            if (isIE8orlower() == 0) {
                ...
                if (navigator.userAgent.match('Firefox/'))
                    audioElement.setAttribute('src', sound_folder' + smallbox.ogg');
                else
                    audioElement.setAttribute('src', sound_folder + 'smallbox.mp3');
