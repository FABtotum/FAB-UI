...
<div class="row">
    <div class="col-sm-6">
        <div class="well text-center">
            <p>Extruder temp: <span id="ext-actual-degrees"><?php echo $_ext_temp ?></span>&deg; /<span class="semi-bold" id="ext-degrees"><?php echo $_ext_temp ?></span>&deg; C <i class="fab-lg fab-fw icon-fab-term fab-2x"></i></p>
            <div id="ext-temp" class="noUiSlider"></div>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="well text-center">
            <p>Bed temp: <span id="bed-actual-degrees"><?php echo $_bed_temp ?></span>&deg; /<span id="bed-degrees"><?php echo $_bed_temp ?></span>&deg; C <i class="fab-lg fab-fw icon-fab-term fab-2x"></i></p>
    						...
    						<fieldset style="background: transparent;">
    							...
    							<section>
    								...
    								<div class="inline-group">
    									...
    									<label class="radio">
    										<input type="radio" id="absolute" <?php echo $_coordinates=="absolute" ? "checked='checked'" : ""; ?>
                                ...
                                <section>
    								...
    								<div class="inline-group">
    									<label class="radio">
    										<input type="radio" name="lights" <?php echo $_lights=="on" ? "checked='checked'" : ""; ?>
    										checked="checked" value="on">
    										<i>
    										</i>
    										On
    									...
    									<label class="radio">
    										<input type="radio" <?php echo $_lights=="off" ? "checked='checked'" : ""; ?>
    										name="lights" value="off">
    										<i>
    										</i>
    										Off
    									</label>
