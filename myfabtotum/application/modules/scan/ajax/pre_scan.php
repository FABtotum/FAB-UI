...
/** CREATE LOG FILES */
$_time                 = time();
$_destination_trace    = '/var/www/temp/scan_check_'.$_time.'.trace';
$_destination_response = '/var/www/temp/scan_response_'.$_time.'.log';
...
/** EXEC COMMAND */
$_command        = 'sudo python /var/www/myfabtotum/python/gmacro.py check_pre_scan '.$_destination_trace.' '.$_destination_response.' > /dev/null';
